...
OUTPUT_DIR     = os.path.join(DRIVE_BASE, "outputs_inception_unet_256_full")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# =============================================================================
# STEP 3: Dataset Manager (no splitting, just pairing image<->mask)
# =============================================================================
...
# =============================================================================
# STEP 6: InceptionV3 U-Net (SAFE SKIPS + AUTO RESIZE)
# =============================================================================
def conv_block(x, f):
...
def build_inception_unet(input_shape=(256,256,3), base_trainable=False):
    ...
    return models.Model(inp, out, name="Inception_UNet_TF219")
...
# =============================================================================
# STEP 8.5: Training curves visualization
# =============================================================================
...
print("✅ DONE — InceptionV3 U-Net trained on full train/val/test folders")
