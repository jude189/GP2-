# MODIFIED: Uses exponential learning rate decay
...
GAMMA = 0.95  # Decay rate - LR is multiplied by this each epoch
# Alternative: use GAMMA = 0.98 for slower decay, or 0.90 for faster decay
...
def main():
    ...
    # CHANGED: Exponential decay scheduler
    scheduler = torch.optim.lr_scheduler.ExponentialLR(optimizer, gamma=GAMMA)

    best_val_dice = -1.0
    early_patience = 12
    patience_count = 0
    history = {"loss": [], "val_loss": [], "dice": [], "val_dice": [], "iou": [], "val_iou": [], "lr": []}
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        # CHANGED: Step the exponential decay scheduler
        scheduler.step()
